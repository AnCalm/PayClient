...
{
    public partial class NotifyForm99vip : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string key = "1p98fswjw031rih";
            ...
            WriteLog.Write("方法:99vip回调，OrderID：" + OrderID + " MerchantOrderID:" + MerchantOrderID +
            ...
            {
                WriteLog.Write("方法:99vip回调，99vip订单号：" + OrderID + " 本地系统订单号:" + MerchantOrderID +
              "签名验证错误，99vip数字签名" + Sign + "本地签名:" + checkSign, LogPathFile.Other.ToString());
            }
