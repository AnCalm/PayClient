...
{
    public partial class NotifyFormShuShan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string key = "geqewl5u1jae4hp";
            ...
            WriteLog.Write("方法:ShuShan回调，OrderID：" + OrderID + " MerchantOrderID:" + MerchantOrderID +
            ...
            if (Sign == checkSign)
            {
                ...
                {
                    int status = new ChargeInterface.Query.QueryShuShan().getOrderStatus(StateInfo, "601");
            ...
            {
                WriteLog.Write("方法:ShuShan回调，ShuShan订单号：" + OrderID + " 本地系统订单号:" + MerchantOrderID +
              "签名验证错误，ShuShan数字签名" + Sign + "本地签名:" + checkSign, LogPathFile.Other.ToString());
            }
