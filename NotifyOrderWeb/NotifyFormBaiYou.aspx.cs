...
{
    public partial class NotifyFormBaiYou : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string key = "bl9kmfdjkxmyff0";
            ...
            WriteLog.Write("方法:BaiYou回调，OrderID：" + OrderID + " MerchantOrderID:" + MerchantOrderID +
            ...
            if (Sign == checkSign)
            {
                ...
                {
                    int status = new ChargeInterface.Query.QueryBaiYou().getOrderStatus(StateInfo, "601");
            ...
            {
                WriteLog.Write("方法:BaiYou回调，BaiYou订单号：" + OrderID + " 本地系统订单号:" + MerchantOrderID +
              "签名验证错误，BaiYou数字签名" + Sign + "本地签名:" + checkSign, LogPathFile.Other.ToString());
            }
