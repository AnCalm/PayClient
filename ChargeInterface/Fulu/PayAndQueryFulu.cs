...
namespace ChargeInterface.Fulu
{
    ...
    public class PayAndQueryFulu
    {
        ...
        public const string key = "ece5e4de39844b0cb37ac4a3e5172b59";
        public const string appkey = "Cg87pKFC/MH5ebKNoK1LDjCPAKYe4i/G8Wl4++n264Egvy5z2LK3zFbz1pjA/mwU";
        ...
        public string SubmitOrder(Order order, string str = null)
        {
            ...
            WriteLog.Write("方法:SubmitOrder，订单号：" + order.OrderInsideID + " Fulu 提交参数:" + str.ToString(), LogPathFile.Recharge.ToString());

            string result = PostAndGet.HttpPostString_utf8(submitUrl, str.ToString(), ref coockie);

            WriteLog.Write("方法:SubmitOrder，订单号：" + order.OrderInsideID + " Fulu 提交返回:" + result, LogPathFile.Recharge.ToString());
